    ...
    >
      <Container disableGutters maxWidth="lg" sx={{ paddingX: 6, paddingY: 8 }}>
        ...
        <Box className="flex justify-between items-center">
          <Typography
            className="font-urbanist"
            sx={{ fontSize: 24, color: "#FFFFFF", marginY: 3, fontWeight: 600 }}
          >
            Private Groups
          </Typography>
          <Button
          ...
          >
            <Typography
              className="text-sm lowercase font-urbanist"
              component="p"
            >
              Create new group
            </Typography>
        ...
        <Stack className="relative mt-16 z-0" direction="column" spacing={3}>
          {userData.users[0].user_groups.map(
            (group_id: string, index: number) => {
              return (
                <Box
                      ...
                      <Box className="flex flex-col gap-2 text-[#1A1A23]">
                        <Box className="flex justify-between items-center">
                          ...
                          <span className=" lg:hidden xl:hidden xxl:hidden text-[#656DE1] text-xs font-urbanist">
                            50 benefits available
                          </span>
                        </Box>
                        <Typography className="opacity-50 text-sm font-urbanist">
                          Lorem ipsum dolor sit amet consectetur, adipisicing
                          elit. Accusamus tempore voluptatem saepe, iure,
                          tempora temporibus dolores labore est veniam deserunt
                          adipisci sunt nulla doloribus dolorem possimus!
                        </Typography>
                      </Box>
                    </Box>
