...
import MobileFilterButton from '../../explore/MobileFilterButton'
...
import FilterIconWhite from '../../explore/icons/FilterIconWhite'
import Link from 'next/link'

const MobileDiscountFilters = ({
  activeOptions,
  setActiveOptions,
}: FilterState) => {
  ...
  return (
    ...
    overflow-y-hidden  
    pr-4 pb-6 text-white sm:hidden"
    >
...
export default MobileDiscountFilters