        ...
        <div className="flex flex-row my-2">
            ...
            <div className="flex-1 border-l-2 border-white pl-4 mr-40">
                ...
                <div className="text-white">
                    ...
                    Aliquam quasi provident ad, nulla voluptates dolores fugit
                    similique saepe. Atque, accusamus voluptates? Consequuntur
                    numquam aspernatur saepe! Illum, itaque. Non, assumenda
                    accusantium.
                </div>
                <div className="flex text-white">
                    <div className="font-semibold text-4xl mt-24">
                        Group Rules
                    </div>
                    <div className="mt-24">
                        <Image
                ...
                <div className="text-white">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                    Reprehenderit explicabo, dolores iusto natus mollitia cumque
                    nostrum sunt maiores voluptates quam delectus molestiae ipsa
                    repellendus ullam! Aspernatur recusandae nam modi ratione!
                </div>
            </div>
        </div>
    )
