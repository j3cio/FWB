                    ...
                    <form onSubmit={!successfulCreation ? create : reset}>
                            ...
                            <>
                                <div className="passwordContainer xl:!border-0 xl:!bg-transparent xl:!shadow-none">
                                    ...
                                    <div className="explanation text-[14px] xxs:text-[12px]">
                                        Enter new password with at least 8
                                        charaters, contain at least 1 number and
                                        1 uppercase
                                    </div>
                        ...
                        {complete && (
                            <div className="passwordContainer xl:!border-0 xl:!bg-transparent xl:!shadow-none">
                                ...
                                <div className="success text-[32px] ">
                                    Success!!
                                </div>
                                <div className="successMessage text-[32px] xxs:text-[24px]">
                                    Yeyyy... You have successfully change your
                                    password
                                </div>
                                <Link
                                    href="/sign-in"
