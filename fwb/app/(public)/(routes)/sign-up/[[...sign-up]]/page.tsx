                                                    ...
                                                    >
                                                        ...
                                                        <div className="message">
                                                            {passwordError
                                                                ...
                                                                .length > 50 ? (
                                                                <>
                                                                    {passwordError.message.substring(
                                                                        0,
                                                                        50
                                                                    )}
                                                                    <br />
                                ...
                                <form>
                                    <div className="signupProcess">
                                        ...
                                        <div className="signupContent">
                                            Hey! You&apos;re almost ready to
                                            start making Freinds
                                            <br></br>
                                            with Benefits.Simply click the
                                            button below to <br></br>
