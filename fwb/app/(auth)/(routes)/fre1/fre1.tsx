                    ...
                    <div>
                        <div>
                            ...
                            <div className="flex justify-center">
                                ...
                                >
                                    <Image
                                        src={
                                            optimisticImageUrl || user.imageUrl
                                        }
                                        alt=""
                                        fill
                                        className="image"
                        ...
                        <div className="flex justify-center mt-4 space-x-4">
                            ...
                            <button
                                ...
                                onClick={() =>
                                    chooseProfilePicture(
                                        '/profilepics/PNG/WomanThree.png'
                                    )
                                }
                            >
