...
export default function UserFlowPage1() {
  ...
  // Initialize the user to be in GetStream db
      ...
      <div className="pageContent">
        ...
        <div className="middleSpacing">
          ...
          <div>
            <div>
              ...
              <div className="flex justify-center">
                ...
                >
                  <Image src={optimisticImageUrl || user.imageUrl} alt="" fill className="image" />
                </div>
              </div>
          ...
          <div className="userForm">
            <form id="usernameForm" className="flex justify-center" onBlur={updateClerkUsername}>
              <input
                type="text"
                id="newUsername"
              ...
              <button className="randomName" type="button" onClick={updateClerkWithRandomUsername}>
