    ...
    <Box sx={{ backgroundColor: '#1A1A23', minHeight: '100vh' }}>
      <Container disableGutters maxWidth="lg">
        ...
        <div className="min-h-screen bg-[#1a1a23]">
          {/*Container div*/}
          <div className="flex h-full w-full flex-1 flex-col items-center justify-center px-[120px] sm-max:items-start sm-max:px-8 xs-max:items-start xs-max:px-6 xxs-max:items-start xxs-max:px-4">
            {/*Profile div*/}
            <div className="mb-[50px] mt-[95px] flex h-1/5 w-full gap-10 border-b-2 border-slate-200 pb-[95px] sm-max:mt-8 sm-max:flex-col sm-max:gap-4 sm-max:pb-6 xs-max:mt-6 xs-max:flex-col xs-max:gap-3 xs-max:pb-4 xxs-max:mt-4 xxs-max:flex-col xxs-max:gap-3 xxs-max:pb-4">
              <Avatar
                alt="123"
                src={`${user?.imageUrl}`}
