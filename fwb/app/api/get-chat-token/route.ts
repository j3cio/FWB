...
export async function GET() {
  try {
    ...
    const streamCLient = StreamChat.getInstance(process.env.NEXT_PUBLIC_STREAM_KEY!, process.env.STREAM_SECRET!); // These could be null if deploying to prod/staging careful
